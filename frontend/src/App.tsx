  ...
  <div className='App'>
    ...
    <section className='section character'>
      ...
      <div className='columns'>
        ...
        <div className='column'>
          <CharacterInfo ac={hero.ac} initiative={hero.initiative} inspiration={hero.inspiration} background={hero.background} alignment={hero.alignment} languages={hero.languages} xp={hero.xp}/>
        </div>
      </div>
